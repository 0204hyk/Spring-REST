...
<body>
	...
	<button id="ajax-post-btn1">AJAX(Post, Form)</button>
	<button id="ajax-post-btn2">AJAX(Post, JSON)</button>
	
	<h3># AJAX 요청 보내기 (PUT)</h3>
	
	<button id="ajax-put-btn1">AJAX(Put, JSON)</button>	
	
	<h3># 다양한 방식으로 요청 보내기</h3>
	...
	<h5>* Put(form)</h5>
	<p><i>form 태그로는 GET과 POST방식 요청만 보낼 수 있다.</i></p>
